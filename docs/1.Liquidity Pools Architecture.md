...
First Draft: Austin Haines &amp; Charlie Wolf (Barefoot Coders)
 Prepared For: Jazear Brooks, Sifchain
...
![](images/image3.png){width="6.5in" height="3.2083333333333335in"}
...
![](images/image2.png){width="4.90625in" height="1.96875in"}
...
![](images/image6.png){width="6.5in" height="1.9583333333333333in"}
```golang 
{
...
![](images/image1.png){width="6.5in" height="1.8611111111111112in"}

**addLiquidity()**: Adds liquidity to an asset&#39;s liquidity pool asymmetrically.

![](images/image4.png){width="6.5in" height="1.8611111111111112in"}
```golang 
{
  getPool(tokenName)
...
![](images/image7.png){width="6.5in" height="1.8611111111111112in"}
```golang 
{
  getPool(tokenName)
  getPooler(tokenName, rowanAddress) if it exists
...
![](images/image5.png){width="6.5in" height="1.8472222222222223in"}
```golang
{
