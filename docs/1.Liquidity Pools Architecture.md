...
```golang 
{
  ...
  if nativeAssetBasis is 0
    nativeAssetUnits is 0
    withdrawNativeAssetAmount is 0
  else
    nativeAssetUnits = lpUnits / ( 10000 / nativeAssetBasis)
    withdrawNativeAssetAmount = nativeAssetBalance / (poolUnits / nativeAssetUnits)
  
  if externalAssetBasis is 0
    externalAssetUnits is 0
    withdrawExternalAssetAmount is 0
  else
  ...
  lpUnitsLeft = lpUnits - ((nativeAssetUnits + externalAssetUnits) / 2)
