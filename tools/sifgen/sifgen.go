...
func (s Sifgen) NodeCreate(moniker, mnemonic string, adminCLPAddresses []string, ipAddr string, peerAddress, genesisURL *string, printDetails, withCosmovisor *bool) {
	witness := node.NewNode(*s.chainID, moniker, mnemonic, adminCLPAddresses, ipAddr, peerAddress, genesisURL, withCosmovisor)
