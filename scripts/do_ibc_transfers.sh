...
SIF_BEFORE_TRANSFERS=$(echo "localnet-1"; terrad q bank balances $(terrad keys show terra -a --keyring-backend=test --home ~/.terranode-1) --node tcp://127.0.0.1:27665; echo ""; echo "localnet-2"; sifnoded q bank balances $(sifnoded keys show sif -a --keyring-backend=test --home ~/.sifnode-2) --node tcp://127.0.0.1:27666; echo ""; echo "localnet-3";  sifnoded q bank balances $(sifnoded keys show sif -a --keyring-backend=test --home ~/.sifnode-2) --node tcp://127.0.0.1:27667)
