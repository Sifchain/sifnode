...
yes Y | sifnodecli tx gov submit-proposal software-upgrade changePoolFormula --from sif --deposit 100000000stake --upgrade-height 15 --title changePoolFormula --description changePoolFormula
sleep 5
