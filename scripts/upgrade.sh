...
sleep 10
yes Y | sifnodecli tx gov submit-proposal software-upgrade release-20210501000000-AddDispensation --from sif --deposit 100000000stake --upgrade-height 10 --title release-20210501000000-AddDispensation --description release-20210501000000-AddDispensation
sleep 5
