...
#sleep 10
yes Y | sifnodecli tx gov submit-proposal software-upgrade release-20210414000000 --from sif --deposit 100000000stake --upgrade-height 10 --title release-20210414000000 --description release-20210414000000
sleep 5
