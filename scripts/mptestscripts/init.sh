...
sifnoded add-genesis-account $(sifnoded keys show sif -a --keyring-backend=test) "15500000000000000000000000000000000rowan,999000000000000000000000000000000stake,3000000000000000000000000000000000ceth,80000000000000000000000000000000cusdc,80000000000000000000000000000000cusdt,80000000000000000000000000000000clink" --keyring-backend=test
sifnoded add-genesis-account $(sifnoded keys show akasha -a --keyring-backend=test) "15500000000000000000000000000000000rowan,999000000000000000000000000000000stake,3000000000000000000000000000000000ceth,80000000000000000000000000000000cusdc,80000000000000000000000000000000cusdt,80000000000000000000000000000000clink" --keyring-backend=test
