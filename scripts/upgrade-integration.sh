...
sleep 7
sifnoded tx gov submit-proposal software-upgrade 0.14.0-rc.1 --from sif --deposit 100000000stake --upgrade-height 28 --title v0.14.0-rc.1 --description v0.14.0-rc.1 --keyring-backend test --chain-id localnet --yes
sleep 7
