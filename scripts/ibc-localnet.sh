...
sifnoded tx ibc-transfer transfer transfer channel-1 sif1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd 10000000000rowan --from sif1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --keyring-backend test --node tcp://127.0.0.1:27665 --chain-id=localnet-1 --gas-prices=0.5rowan --gas=300000 -y --packet-timeout-timestamp 60000000000000 --home ~/.sifnode-1
sifnoded tx ibc-transfer transfer transfer channel-1 sif1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd 10000000000ceth --from sif1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --keyring-backend test --node tcp://127.0.0.1:27665 --chain-id=localnet-1 --gas-prices=0.5rowan --gas=300000 -y --packet-timeout-timestamp 60000000000000 --home ~/.sifnode-1
