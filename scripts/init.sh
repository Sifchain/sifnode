...
echo "Generating deterministic account - faucet"
echo "slight antenna era mass whip word marine unfold fitness token dry egg combine april car mistake school capable fiber dismiss ensure toward famous spider" | sifnodecli keys add faucet --recover
...
sifnoded add-genesis-account $(sifnodecli keys show faucet -a) 1000000000rowan
