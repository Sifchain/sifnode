...
sifnoded add-genesis-account $(sifnoded keys show sif -a --keyring-backend=test) 5000000000000000000000000000rowan,500000000000000000000000ceth,1000000000000000000000000cusdt --keyring-backend=test
sifnoded add-genesis-account $(sifnoded keys show akasha -a --keyring-backend=test) 500000000000000000000000rowan,500000000000000000000000ceth,500000000000000000000000cusdt --keyring-backend=test
