...
SIFCHAIN_ID=sifchain-1 \
  ...
  COMDEX_CHANNEL_ID=channel-64 \
  COMDEX_COUNTERPARTY_CHANNEL_ID=channel-27
  HUAHUA_CHAIN_ID=chihuahua-1 \
  HUAHUA_CHANNEL_ID=channel-58 \
  HUAHUA_COUNTERPARTY_CHANNEL_ID=channel-20 \
  STARGAZE_CHAIN_ID=stargaze-1 \
  STARGAZE_CHANNEL_ID=channel-57 \
  STARGAZE_COUNTERPARTY_CHANNEL_ID=channel-41 \
  ...
  BITSONG_CHANNEL_ID=channel-62 \
  BITSONG_COUNTERPARTY_CHANNEL_ID=channel-7 \
  KICHAIN_CHAIN_ID=kichain-2 \
  KICHAIN_CHANNEL_ID=channel-56 \
  KICHAIN_COUNTERPARTY_CHANNEL_ID=channel-17 \
  LIKECOIN_CHAIN_ID=likecoin-mainnet-2 \
  LIKECOIN_CHANNEL_ID=channel-59 \
  LIKECOIN_COUNTERPARTY_CHANNEL_ID=channel-12 \
  CERBERUS_CHAIN_ID=cerberus-chain-1 \
  CERBERUS_CHANNEL_ID=channel-63 \
  CERBERUS_COUNTERPARTY_CHANNEL_ID=channel-4 \
  GRAVITY_CHAIN_ID=gravity-bridge-3 \
  GRAVITY_CHANNEL_ID=channel-60 \
  GRAVITY_COUNTERPARTY_CHANNEL_ID=channel-66
