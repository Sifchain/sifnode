...
def test_case_2():
    ...
    wait_for_sifchain_addr_balance(owner_addr, SIF_ETH, owner_sifchain_balance_before_tx - amount, 7)
    wait_for_eth_balance(operatorAddress, ETHEREUM_ETH, operator_balance_before_tx + amount, 7)
