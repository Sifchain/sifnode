...
#sifnodecli tx send sif sif1w3dhr896jxxctmrl72axlz8uv9gcn9dr6rr0pt 10000000000000000rowan --keyring-backend test --fees 100000rowan  --yes
...
'''if __name__ == "__main__":
    ...
    try:
        ...
        claimed_amount_single_recipient = int(recipient_with_respective_distributed_amount[one_claiming_address]) 
        logging.info(f"amount of one selected claiming address  = {claimed_amount_single_recipient}") 
