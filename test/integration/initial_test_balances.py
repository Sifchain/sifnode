...
from test_utilities import amount_in_wei, \
    sif_tx_send, transact_ethereum_currency_to_sifchain_addr, get_required_env_var
...
def setup_currencies():
    ...
    time.sleep(15)
    sif_tx_send(owner_addr, user1_addr, amount_in_wei(23), "rowan", get_required_env_var("OWNER_PASSWORD"))
