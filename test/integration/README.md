...
do
  ROWAN_SOURCE=sif1m849vehkjzxkaz03uwsvyty5csp7dfysj65fp3 DESTINATION_ACCOUNT=$i python3 -m pytest --color=yes -x -olog_cli=true -olog_level=DEBUG -v -olog_file=vagrant/data/pytest.log src/py/token_distribution.py
done
```
