...
type GenesisState struct {
	...
	MintController      *MintController      `protobuf:"bytes,4,opt,name=mint_controller,json=mintController,proto3" json:"mint_controller,omitempty"`
}
...
func (m *GenesisState) GetMintController() *MintController {
	if m != nil {
		return m.MintController
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*MintController)(nil), "sifnode.dispensation.v1.MintController")
}
...
var fileDescriptor_bfdf912039cd8799 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MintController != nil {
		{
			size, err := m.MintController.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MintController", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MintController == nil {
				m.MintController = &MintController{}
			}
			if err := m.MintController.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
