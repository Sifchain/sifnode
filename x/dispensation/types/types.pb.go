...
type MaxRecordsPerBlock struct {
	MaxRecords int64 `protobuf:"varint,1,opt,name=max_records,json=maxRecords,proto3" json:"max_records,omitempty"`
}

func (m *MaxRecordsPerBlock) Reset()         { *m = MaxRecordsPerBlock{} }
func (m *MaxRecordsPerBlock) String() string { return proto.CompactTextString(m) }
func (*MaxRecordsPerBlock) ProtoMessage()    {}
func (*MaxRecordsPerBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfdf912039cd8799, []int{1}
}
func (m *MaxRecordsPerBlock) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MaxRecordsPerBlock) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MaxRecordsPerBlock.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MaxRecordsPerBlock) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MaxRecordsPerBlock.Merge(m, src)
}
func (m *MaxRecordsPerBlock) XXX_Size() int {
	return m.Size()
}
func (m *MaxRecordsPerBlock) XXX_DiscardUnknown() {
	xxx_messageInfo_MaxRecordsPerBlock.DiscardUnknown(m)
}

var xxx_messageInfo_MaxRecordsPerBlock proto.InternalMessageInfo

func (m *MaxRecordsPerBlock) GetMaxRecords() int64 {
	if m != nil {
		return m.MaxRecords
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*MaxRecordsPerBlock)(nil), "sifnode.dispensation.v1.MaxRecordsPerBlock")
...
var fileDescriptor_bfdf912039cd8799 = []byte{
	...
	,
}
...
func (m *MaxRecordsPerBlock) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MaxRecordsPerBlock) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MaxRecordsPerBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.MaxRecords != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxRecords))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MaxRecordsPerBlock) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.MaxRecords != 0 {
		n += 1 + sovTypes(uint64(m.MaxRecords))
	}
	return n
}
...
func (m *MaxRecordsPerBlock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MaxRecordsPerBlock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MaxRecordsPerBlock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxRecords |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
