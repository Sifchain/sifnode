...
func init() {
	proto.RegisterType((*MsgAddAccount)(nil), "sifnode.tokenregistry.v1.MsgAddAccount")
	proto.RegisterType((*MsgAddAccountResponse)(nil), "sifnode.tokenregistry.v1.MsgAddAccountResponse")
	proto.RegisterType((*MsgRemoveAccount)(nil), "sifnode.tokenregistry.v1.MsgRemoveAccount")
	proto.RegisterType((*MsgRemoveAccountResponse)(nil), "sifnode.tokenregistry.v1.MsgRemoveAccountResponse")
}
...
var fileDescriptor_600acd904f18192e = []byte{
	...
	,
}
...
func (c *msgClient) AddAccount(ctx context.Context, in *MsgAddAccount, opts ...grpc.CallOption) (*MsgAddAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sifnode.tokenregistry.v1.Msg/AddAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RemoveAccount(ctx context.Context, in *MsgRemoveAccount, opts ...grpc.CallOption) (*MsgRemoveAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sifnode.tokenregistry.v1.Msg/RemoveAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sifnode.tokenregistry.v1.Msg/AddAccount",
	}
...
func _Msg_RemoveAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sifnode.tokenregistry.v1.Msg/RemoveAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
