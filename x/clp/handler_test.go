...
func TestCreatePool(t *testing.T) {
	...
	require.Error(t, err)
	// Whitelist Asset
	app.TokenRegistryKeeper.SetToken(ctx, &tokenregistrytypes.RegistryEntry{IsWhitelisted: true, Denom: newAsset.Symbol, Decimals: 18, Permissions: []tokenregistrytypes.Permission{tokenregistrytypes.Permission_PERMISSION_CLP}})
