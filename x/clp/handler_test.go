...
func TestCreatePool(t *testing.T) {
	...
	crossChainFee := sdk.NewCoin(clptypes.NativeSymbol, sdk.Int(initialBalance))
	_ = keeper.GetBankKeeper().AddCoins(ctx, signer, sdk.Coins{externalCoin, crossChainFee})

	ok := keeper.HasBalance(ctx, signer, externalCoin)
	assert.True(t, ok, "")
	ok = keeper.HasBalance(ctx, signer, crossChainFee)
	assert.True(t, ok, "")
	...
	crossChainFee = sdk.NewCoin(clptypes.NativeSymbol, sdk.Int(initialBalance.Sub(poolBalance)))
	ok = keeper.HasBalance(ctx, signer, externalCoin)
	assert.True(t, ok, "")
	ok = keeper.HasBalance(ctx, signer, crossChainFee)
	assert.True(t, ok, "")
...
func TestAddLiquidity(t *testing.T) {
	...
	crossChainFee = sdk.NewCoin(clptypes.NativeSymbol, sdk.Int(initialBalance.Sub(addLiquidityAmount).Sub(sdk.ZeroUint())))
	...
	_ = keeper.GetBankKeeper().AddCoins(ctx, signer2, sdk.Coins{externalCoin, crossChainFee})
...
func TestAddLiquidity_LargeValue(t *testing.T) {
	...
	crossChainFee := sdk.NewCoin(clptypes.NativeSymbol, sdk.Int(poolBalanceRowan).Add(sdk.Int(addLiquidityAmountRowan)))
	_ = keeper.GetBankKeeper().AddCoins(ctx, signer, sdk.Coins{externalCoin, crossChainFee})
...
func TestRemoveLiquidity(t *testing.T) {
	...
	crossChainFee := sdk.NewCoin(clptypes.NativeSymbol, sdk.Int(initialBalance))
	_ = keeper.GetBankKeeper().AddCoins(ctx, signer, sdk.Coins{externalCoin, crossChainFee})
	_ = keeper.GetBankKeeper().AddCoins(ctx, newLP, sdk.Coins{externalCoin, crossChainFee})
...
func TestSwap(t *testing.T) {
	...
	_ = keeper.GetBankKeeper().AddCoins(ctx, signer, sdk.Coins{externalCoin1, crossChainFee})
