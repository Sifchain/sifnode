...
var (
	...
	ErrPoolDoesNotExist                                = sdkerrors.Register(ModuleName, 3, "pool does not exist")
	ErrLiquidityProviderDoesNotExist                   = sdkerrors.Register(ModuleName, 4, "liquidity Provider does not exist")
	ErrInValidAsset                                    = sdkerrors.Register(ModuleName, 5, "asset is invalid")
	ErrInValidAmount                                   = sdkerrors.Register(ModuleName, 6, "amount is invalid")
	...
	ErrReachedMaxRowanLiquidityThreshold               = sdkerrors.Register(ModuleName, 38, "Unable to swap, reached maximum rowan liquidity threshold")
	ErrMaxRowanLiquidityThresholdAssetPoolDoesNotExist = sdkerrors.Register(ModuleName, 39, "Unable to swap, max rowan liquidity threshold asset pool does not exist")
)
