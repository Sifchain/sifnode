...
var (
	...
	ErrNotAllowedToSellAsset                           = sdkerrors.Register(ModuleName, 38, "Unable to swap, not allowed to sell selected asset")
	ErrNotAllowedToBuyAsset                            = sdkerrors.Register(ModuleName, 39, "Unable to swap, not allowed to buy selected asset")
	ErrReachedMaxRowanLiquidityThreshold               = sdkerrors.Register(ModuleName, 40, "Unable to swap, reached maximum rowan liquidity threshold")
	ErrMaxRowanLiquidityThresholdAssetPoolDoesNotExist = sdkerrors.Register(ModuleName, 41, "Unable to swap, max rowan liquidity threshold asset pool does not exist")
)
