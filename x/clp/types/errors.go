...
var (
	...
	ErrReachedMaxRowanLiquidityThreshold               = sdkerrors.Register(ModuleName, 42, "Unable to swap, reached maximum rowan liquidity threshold")
	ErrMaxRowanLiquidityThresholdAssetPoolDoesNotExist = sdkerrors.Register(ModuleName, 43, "Unable to swap, max rowan liquidity threshold asset pool does not exist")
)
