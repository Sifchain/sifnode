...
type ParamsRes struct {
	...
	SwapAssetPermissions   []*SwapAssetPermission                 `protobuf:"bytes,4,rep,name=swap_asset_permissions,json=swapAssetPermissions,proto3" json:"swap_asset_permissions,omitempty"`
}
...
func (m *ParamsRes) GetSwapAssetPermissions() []*SwapAssetPermission {
	if m != nil {
		return m.SwapAssetPermissions
	}
	return nil
}
...
var fileDescriptor_5f4edede314ca3fd = []byte{
	...
	,
}
...
func (m *ParamsRes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SwapAssetPermissions) > 0 {
		for iNdEx := len(m.SwapAssetPermissions) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SwapAssetPermissions[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ParamsRes) Size() (n int) {
	...
	n += 1 + l + sovQuerier(uint64(l))
	if len(m.SwapAssetPermissions) > 0 {
		for _, e := range m.SwapAssetPermissions {
			l = e.Size()
			n += 1 + l + sovQuerier(uint64(l))
		}
	}
...
func (m *ParamsRes) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SwapAssetPermissions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SwapAssetPermissions = append(m.SwapAssetPermissions, &SwapAssetPermission{})
			if err := m.SwapAssetPermissions[len(m.SwapAssetPermissions)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
