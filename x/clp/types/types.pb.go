...
type Pool struct {
	...
	CurrentNativeLiquidityThreshold github_com_cosmos_cosmos_sdk_types.Uint `protobuf:"bytes,19,opt,name=current_native_liquidity_threshold,json=currentNativeLiquidityThreshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Uint" json:"current_native_liquidity_threshold"`
}
...
var fileDescriptor_a09f92a67752e669 = []byte{
	...
	,
}
...
func (m *Pool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.CurrentNativeLiquidityThreshold.Size()
		i -= size
		if _, err := m.CurrentNativeLiquidityThreshold.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *Pool) Size() (n int) {
	...
	n += 2 + l + sovTypes(uint64(l))
	l = m.CurrentNativeLiquidityThreshold.Size()
	n += 2 + l + sovTypes(uint64(l))
	return n
}
...
func (m *Pool) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CurrentNativeLiquidityThreshold", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CurrentNativeLiquidityThreshold.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
