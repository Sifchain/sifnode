...
type Pool struct {
	...
	NormalizedPmtpNativeWeight   github_com_cosmos_cosmos_sdk_types.Dec  `protobuf:"bytes,5,opt,name=normalized_pmtp_native_weight,json=normalizedPmtpNativeWeight,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"normalized_pmtp_native_weight" yaml:"normalized_pmtp"`
	NormalizedPmtpExternalWeight github_com_cosmos_cosmos_sdk_types.Dec  `protobuf:"bytes,6,opt,name=normalized_pmtp_external_weight,json=normalizedPmtpExternalWeight,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"normalized_pmtp_external_weight" yaml:"normalized_pmtp"`
	SwapPriceNative              *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,7,opt,name=swap_price_native,json=swapPriceNative,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"swap_price_native,omitempty" yaml:"swap_price "`
	SwapPriceExternal            *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,8,opt,name=swap_price_external,json=swapPriceExternal,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"swap_price_external,omitempty" yaml:"swap_price "`
}
...
var fileDescriptor_a09f92a67752e669 = []byte{
	...
	,
}
...
func (m *Pool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size := m.NormalizedPmtpExternalWeight.Size()
		i -= size
		if _, err := m.NormalizedPmtpExternalWeight.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintTypes(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0x32
	{
		size := m.NormalizedPmtpNativeWeight.Size()
		i -= size
		if _, err := m.NormalizedPmtpNativeWeight.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintTypes(dAtA, i, uint64(size))
	}
...
func (m *Pool) Size() (n int) {
	...
	l = m.PoolUnits.Size()
	n += 1 + l + sovTypes(uint64(l))
	l = m.NormalizedPmtpNativeWeight.Size()
	n += 1 + l + sovTypes(uint64(l))
	l = m.NormalizedPmtpExternalWeight.Size()
	n += 1 + l + sovTypes(uint64(l))
	if m.SwapPriceNative != nil {
...
func (m *Pool) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NormalizedPmtpNativeWeight", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.NormalizedPmtpNativeWeight.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NormalizedPmtpExternalWeight", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.NormalizedPmtpExternalWeight.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
