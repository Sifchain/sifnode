...
type MsgUpdatePmtpParams struct {
	...
	StartNewPolicy           bool   `protobuf:"varint,3,opt,name=start_new_policy,json=startNewPolicy,proto3" json:"start_new_policy,omitempty"`
	PmtpPeriodEpochLength    int64  `protobuf:"varint,4,opt,name=pmtp_period_epoch_length,json=pmtpPeriodEpochLength,proto3" json:"pmtp_period_epoch_length,omitempty"`
	PmtpPeriodStartBlock     int64  `protobuf:"varint,5,opt,name=pmtp_period_start_block,json=pmtpPeriodStartBlock,proto3" json:"pmtp_period_start_block,omitempty"`
	PmtpPeriodEndBlock       int64  `protobuf:"varint,6,opt,name=pmtp_period_end_block,json=pmtpPeriodEndBlock,proto3" json:"pmtp_period_end_block,omitempty"`
}
...
func (m *MsgUpdatePmtpParams) GetStartNewPolicy() bool {
	if m != nil {
		return m.StartNewPolicy
	}
	return false
}
...
var fileDescriptor_a3bff5b30808c4f3 = []byte{
	...
	,
}
...
func (m *MsgUpdatePmtpParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartNewPolicy", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
