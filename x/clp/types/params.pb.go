...
type ProviderDistributionPeriod struct {
	...
	DistributionPeriodMod        int64                                  `protobuf:"varint,4,opt,name=distribution_period_mod,json=distributionPeriodMod,proto3" json:"distribution_period_mod,omitempty"`
}
...
func (m *ProviderDistributionPeriod) GetDistributionPeriodMod() int64 {
	if m != nil {
...
var fileDescriptor_61de66e331088d04 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DistributionPeriodMod |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
