...
func (s *AndrewTestSuite) SetupSuite() {
...
func (s *AndrewTestSuite) TearDownSuite() {
...
func (s *AndrewTestSuite) TestOpenLongCmd() {
...
func (s *AndrewTestSuite) TestCloseLongCmd() {
	val := s.network.Validators[0]
...
func TestAndrewTestSuite(t *testing.T) {
	suite.Run(t, new(AndrewTestSuite))
}
