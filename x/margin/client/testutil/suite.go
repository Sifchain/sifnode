	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedMtp: margintypes.MTP{
				...
				InterestUnpaid:   sdk.NewUintFromString("72759593488"),
		...
		},
		{
			...
			expectedMtp: margintypes.MTP{
				...
				CollateralAmount: collateralAmount,
				Liabilities:      collateralAmount,
				InterestUnpaid:   sdk.NewUintFromString("72760009820"),
				CustodyAsset:     borrowAsset,
				CustodyAmount:    sdk.NewUintFromString("2226145389"),
				Leverage:         sdk.MustNewDecFromStr("2.0"),
		...
		},
		{
			...
			expectedMtp: margintypes.MTP{
				...
				CollateralAmount: collateralAmount,
				Liabilities:      collateralAmount,
				InterestUnpaid:   sdk.NewUintFromString("72760703708"),
				CustodyAsset:     borrowAsset,
				CustodyAmount:    sdk.NewUintFromString("2226145389"),
				Leverage:         sdk.MustNewDecFromStr("2.0"),
		...
		},
		{
			...
			expectedMtp: margintypes.MTP{
				...
				CollateralAmount: collateralAmount,
				Liabilities:      collateralAmount,
				InterestUnpaid:   sdk.NewUintFromString("72761397596"),
				CustodyAsset:     borrowAsset,
				CustodyAmount:    sdk.NewUintFromString("2226145389"),
				Leverage:         sdk.MustNewDecFromStr("2.0"),
		...
		},
		{
			...
			expectedMtp: margintypes.MTP{
				...
				CollateralAmount: collateralAmount,
				Liabilities:      collateralAmount,
				InterestUnpaid:   sdk.NewUintFromString("72761987401"),
				CustodyAsset:     borrowAsset,
				CustodyAmount:    sdk.NewUintFromString("2226145389"),
				Leverage:         sdk.MustNewDecFromStr("2.0"),
