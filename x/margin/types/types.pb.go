...
type Params struct {
	...
	RemovalQueueThreshold                    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,9,opt,name=removal_queue_threshold,json=removalQueueThreshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"removal_queue_threshold"`
	MaxOpenPositions                         uint64                                 `protobuf:"varint,10,opt,name=max_open_positions,json=maxOpenPositions,proto3" json:"max_open_positions,omitempty"`
	PoolOpenThreshold                        github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,11,opt,name=pool_open_threshold,json=poolOpenThreshold,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"pool_open_threshold"`
	ForceCloseFundPercentage                 github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,12,opt,name=force_close_fund_percentage,json=forceCloseFundPercentage,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"force_close_fund_percentage"`
	ForceCloseFundAddress                    string                                 `protobuf:"bytes,13,opt,name=force_close_fund_address,json=forceCloseFundAddress,proto3" json:"force_close_fund_address,omitempty"`
	IncrementalInterestPaymentFundPercentage github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,14,opt,name=incremental_interest_payment_fund_percentage,json=incrementalInterestPaymentFundPercentage,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"incremental_interest_payment_fund_percentage"`
	IncrementalInterestPaymentFundAddress    string                                 `protobuf:"bytes,15,opt,name=incremental_interest_payment_fund_address,json=incrementalInterestPaymentFundAddress,proto3" json:"incremental_interest_payment_fund_address,omitempty"`
	SqModifier                               github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,16,opt,name=sq_modifier,json=sqModifier,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"sq_modifier"`
	SafetyFactor                             github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,17,opt,name=safety_factor,json=safetyFactor,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"safety_factor"`
	ClosedPools                              []string                               `protobuf:"bytes,18,rep,name=closed_pools,json=closedPools,proto3" json:"closed_pools,omitempty"`
	IncrementalInterestPaymentEnabled        bool                                   `protobuf:"varint,19,opt,name=incremental_interest_payment_enabled,json=incrementalInterestPaymentEnabled,proto3" json:"incremental_interest_payment_enabled,omitempty"`
	WhitelistingEnabled                      bool                                   `protobuf:"varint,20,opt,name=whitelisting_enabled,json=whitelistingEnabled,proto3" json:"whitelisting_enabled,omitempty"`
}
...
var fileDescriptor_b3994728d56e8650 = []byte{
	...
	0xed, 0x26, 0xad, 0xd9, 0x9c, 0x24, 0x2e, 0x96, 0xbf, 0xff, 0x2e, 0xb8, 0x8b, 0x05, 0x7c, 0x2a,
	...
	,
}
