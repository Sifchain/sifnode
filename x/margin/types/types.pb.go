...
func (Position) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_d3043e343052394a, []int{0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3043e343052394a, []int{1}
}
...
func (*MTP) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3043e343052394a, []int{2}
}
...
func init() { proto.RegisterFile("margin/v1/types.proto", fileDescriptor_d3043e343052394a) }

var fileDescriptor_d3043e343052394a = []byte{
	...
	,
}
