...
type MsgAdminClose struct {
	Signer   string `protobuf:"bytes,1,opt,name=signer,proto3" json:"signer,omitempty"`
	CloseAll bool   `protobuf:"varint,2,opt,name=close_all,json=closeAll,proto3" json:"close_all,omitempty"`
}
...
func (m *MsgAdminClose) GetCloseAll() bool {
	if m != nil {
		return m.CloseAll
	}
	return false
...
var fileDescriptor_4dd3bc05d7e781ea = []byte{
	...
	,
}
...
func (m *MsgAdminClose) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloseAll", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
