...
func NewTokenMetadata(cosmosSender sdk.AccAddress, name string, symbol string, decimals int32, tokenAddress EthereumAddress, networkDescriptor oracletypes.NetworkDescriptor) TokenMetadataAddRequest {
