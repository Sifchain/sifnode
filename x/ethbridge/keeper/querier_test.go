...
const (
	...
	TestCrossChainFeeResponseJSON = "{\"fee_currency\":\"sifBridge00010x0000000000000000000000000000000000000000\",\"fee_currency_gas\":\"1\",\"minimum_lock_cost\":\"1\",\"minimum_burn_cost\":\"1\",\"first_burn_double_peggy_cost\":\"1\"}"
)
...
func TestParseEthProphecy(t *testing.T) {
	...
	initialEthBridgeClaim := types.CreateTestEthClaim(
		...
		testEthereumAddress, types.TestCoinsAmount, types.TestCoinsSymbol, types.ClaimType_CLAIM_TYPE_LOCK, types.TestDecimals, types.TestName)
