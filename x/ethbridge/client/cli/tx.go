...
func GetCmdBurn(cdc *codec.Codec) *cobra.Command {
	return &cobra.Command{
		Use:   "burn [cosmos-sender-address] [ethereum-receiver-address] [amount] [symbol] [max-ceth-amount] --ethereum-chain-id [ethereum-chain-id]",
...
func GetCmdLock(cdc *codec.Codec) *cobra.Command {
	//nolint:lll
	return &cobra.Command{
		Use:   "lock [cosmos-sender-address] [ethereum-receiver-address] [amount] [symbol] [max-ceth-amount] --ethereum-chain-id [ethereum-chain-id]",
