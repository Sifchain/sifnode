...
type CrossChainFeeConfig struct {
	...
	FirstLockDoublePeggyCost github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,5,opt,name=first_lock_double_peggy_cost,json=firstLockDoublePeggyCost,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"first_lock_double_peggy_cost" yaml:"first_lock_double_peggy_cost"`
}
...
type ProphecyInfo struct {
	...
	DoublePeg            bool                                   `protobuf:"varint,10,opt,name=double_peg,json=doublePeg,proto3" json:"double_peg,omitempty"`
...
type ConsensusNeeded struct {
	ConsensusNeeded float32 `protobuf:"fixed32,1,opt,name=consensus_needed,json=consensusNeeded,proto3" json:"consensus_needed,omitempty"`
}
...
func (m *ConsensusNeeded) GetConsensusNeeded() float32 {
	if m != nil {
...
var fileDescriptor_dac1b931484f4203 = []byte{
	...
	,
}
...
func (m *ConsensusNeeded) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ConsensusNeeded != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ConsensusNeeded))))
		i--
		dAtA[i] = 0xd
	}
	return len(dAtA) - i, nil
...
func (m *ConsensusNeeded) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			iNdEx += 4
			m.ConsensusNeeded = float32(math.Float32frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
			if err != nil {
