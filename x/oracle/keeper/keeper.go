...
// SetFeeInfo set native token for a network
func (k Keeper) SetFeeInfo(ctx sdk.Context, networkDescriptor types.NetworkDescriptor, nativeToken string, gas, lockCost, burnCost sdk.Int) error {
	k.SetCrossChainFee(ctx, types.NewNetworkIdentity(networkDescriptor), nativeToken, gas, lockCost, burnCost)
	return nil
}
