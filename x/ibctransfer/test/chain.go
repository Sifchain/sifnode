...
type TestChain struct {
	...
	QueryServer   coretypes.QueryServer
...
func CreateTestChain(t *testing.T, chainID string) *TestChain {
	...
	chain := &TestChain{
		...
		Connections:   make([]*types.TestConnection, 0),
	}
...
// GetConnection retrieves an IBC Connection for the provided types.TestConnection. The
// connection is expected to exist otherwise testing will fail.
func (chain *TestChain) GetConnection(testConnection *types.TestConnection) connectiontypes.ConnectionEnd {
...
func (chain *TestChain) GetChannel(testChannel types.TestChannel) channeltypes.Channel {
...
// AddTestConnection appends a new types.TestConnection which contains references
// to the connection id, client id and counterparty client id.
func (chain *TestChain) AddTestConnection(clientID, counterpartyClientID string) *types.TestConnection {
...
func (chain *TestChain) ConstructNextTestConnection(clientID, counterpartyClientID string) *types.TestConnection {
...
func (chain *TestChain) GetFirstTestConnection(clientID, counterpartyClientID string) *types.TestConnection {
...
func (chain *TestChain) AddTestChannel(conn *types.TestConnection, portID string) types.TestChannel {
...
func (chain *TestChain) NextTestChannel(conn *types.TestConnection, portID string) types.TestChannel {
