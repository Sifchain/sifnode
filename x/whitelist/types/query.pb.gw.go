...
var (
	pattern_Query_Denoms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sifchain", "whitelist", "v1beta1", "denoms"}, "", runtime.AssumeColonVerbOpt(false)))
)
