...
func DefaultRegistry() Registry {
	return Registry{
		Entries: []*RegistryEntry{
			{IsWhitelisted: true, Denom: "ibc/1690CAACCF73943D04A9BD36F8C09D066DA3A4C9914292B2813362D0FE9A34B5", BaseDenom: "uphoton", SrcChannel: "channel-23", DestChannel: "channel-16", Path: "transfer/channel-23", DisplayName: "uPHOTON", ExternalSymbol: "uPHOTON", Decimals: 6},
			...
			{IsWhitelisted: true, Denom: "rowan", Decimals: 18, IbcCounterPartyDenom: "urowan"},
			{IsWhitelisted: true, Denom: "urowan", Decimals: 10, UnitDenom: "rowan"},
			...
			{IsWhitelisted: true, Denom: "ceth", Decimals: 18, IbcCounterPartyDenom: "ueth"},
			{IsWhitelisted: true, Denom: "ueth", Decimals: 10, UnitDenom: "ueth"},
			{IsWhitelisted: true, Denom: "cdai", Decimals: 18, IbcCounterPartyDenom: "udai"},
			{IsWhitelisted: true, Denom: "udai", Decimals: 10, UnitDenom: "cdai"},
			/*
