...
type RegistryEntry struct {
	...
	DoublePeggedNetworksMap map[uint32]bool `protobuf:"bytes,19,rep,name=double_pegged_networks_map,json=doublePeggedNetworksMap,proto3" json:"double_pegged_networks_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (m *RegistryEntry) GetDoublePeggedNetworksMap() map[uint32]bool {
	if m != nil {
		return m.DoublePeggedNetworksMap
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[uint32]bool)(nil), "sifnode.tokenregistry.v1.RegistryEntry.DoublePeggedNetworksMapEntry")
...
var fileDescriptor_d08afdaf425e66ea = []byte{
	...
	,
}
...
func (m *RegistryEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DoublePeggedNetworksMap) > 0 {
		for k := range m.DoublePeggedNetworksMap {
			v := m.DoublePeggedNetworksMap[k]
			baseI := i
			i--
			if v {
				dAtA[i] = 1
...
func (m *RegistryEntry) Size() (n int) {
	...
	if len(m.DoublePeggedNetworksMap) > 0 {
		for k, v := range m.DoublePeggedNetworksMap {
			_ = k
			_ = v
...
func (m *RegistryEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DoublePeggedNetworksMap", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DoublePeggedNetworksMap == nil {
				m.DoublePeggedNetworksMap = make(map[uint32]bool)
			}
			var mapkey uint32
			var mapvalue bool
			for iNdEx < postIndex {
			...
			m.DoublePeggedNetworksMap[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
