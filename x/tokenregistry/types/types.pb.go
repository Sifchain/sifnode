...
type RegistryEntry struct {
	...
	Peggy_1Denom           string          `protobuf:"bytes,20,opt,name=peggy_1_denom,json=peggy1Denom,proto3" json:"peggy_1_denom,omitempty"`
}
...
func (m *RegistryEntry) GetPeggy_1Denom() string {
	if m != nil {
		return m.Peggy_1Denom
	}
	return ""
}
...
var fileDescriptor_d08afdaf425e66ea = []byte{
	...
	0x34, 0xeb, 0x83, 0x0d, 0x67, 0x1b, 0xb0, 0x15, 0x68, 0x81, 0xd8, 0x4e, 0x07, 0x63, 0x4d, 0x66,
	...
	,
	...
	,
	...
	0xff, 0xff, 0x02, 0xb6, 0x7e, 0xdc, 0xec, 0x06, 0x00, 0x00,
}
...
func (m *RegistryEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Peggy_1Denom) > 0 {
		i -= len(m.Peggy_1Denom)
		copy(dAtA[i:], m.Peggy_1Denom)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.Peggy_1Denom)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa2
...
func (m *RegistryEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Peggy_1Denom", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Peggy_1Denom = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
