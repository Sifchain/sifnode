...
type RegistryEntry struct {
	...
	DoublePeggedNetworks   []types.NetworkDescriptor `protobuf:"varint,19,rep,packed,name=double_pegged_networks,json=doublePeggedNetworks,proto3,enum=sifnode.oracle.v1.NetworkDescriptor" json:"double_pegged_networks,omitempty"`
}
...
func (m *RegistryEntry) GetDoublePeggedNetworks() []types.NetworkDescriptor {
	if m != nil {
		return m.DoublePeggedNetworks
	}
	return nil
}
...
var fileDescriptor_d08afdaf425e66ea = []byte{
	...
	,
}
...
func (m *RegistryEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DoublePeggedNetworks) > 0 {
		dAtA3 := make([]byte, len(m.DoublePeggedNetworks)*10)
		var j2 int
		for _, num := range m.DoublePeggedNetworks {
			for num >= 1<<7 {
...
func (m *RegistryEntry) Size() (n int) {
	...
	if len(m.DoublePeggedNetworks) > 0 {
		l = 0
		for _, e := range m.DoublePeggedNetworks {
			l += sovTypes(uint64(e))
		}
		...
		case 19:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= types.NetworkDescriptor(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				m.DoublePeggedNetworks = append(m.DoublePeggedNetworks, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				var elementCount int
				if elementCount != 0 && len(m.DoublePeggedNetworks) == 0 {
					m.DoublePeggedNetworks = make([]types.NetworkDescriptor, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v types.NetworkDescriptor
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field DoublePeggedNetworks", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
