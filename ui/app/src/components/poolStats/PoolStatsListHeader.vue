  ...
  <div class="header">
    ...
    <div class="col-lg">
      ...
      <span>
        APY&nbsp;
        <Tooltip
          message="Annual percentage return earned via our Validator subsidy program for providing liquidity to this pool. "
        >
          <Icon icon="info-box-white" />
        </Tooltip>
      </span>
    ...
    <div class="col-sm">
      <span>
        Total APY
        <Tooltip
          message="Total APY earned (Pool + Validator Subsidy) by providing liquidity to this pool."
        >
          <Icon icon="info-box-white" />
        </Tooltip>
      </span>
