      ...
      <template v-slot:right>
        <WithWallet>
          <template v-slot:disconnected="{ requestDialog }">
            <SifButton data-handle="button-not-connected" round small ghost secondary @click="requestDialog">
              Not connected
            </SifButton>
          </template>
          <template v-slot:connected="{ requestDialog }">
            <SifButton data-handle="button-connected" small ghost success round @click="requestDialog">
              Connected
            </SifButton>
          </template>
        </WithWallet>
