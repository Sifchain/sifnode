  ...
  <Layout :header="false" title="Staking & Rewards" backLink="/peg">
    <div class="liquidity-container">
      ...
      <div v-else>
        ...
        <p class="">
          1. 
            <a class="ul" href="https://medium.com/sifchain-finance/uses-for-rowan-the-polyvalent-token-for-omni-chain-decentralized-exchange-dex-3207e7f70f02?source=collection_home---4------10-----------------------" target="_blank">Validator Subsidy</a>:
