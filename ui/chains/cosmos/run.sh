...
sifnoded add-genesis-account $(sifnodecli keys show ${SHADOWFIEND_NAME} -a) 123456789012345678901234567890rowan,123456789012345678901234567890catk,123456789012345678901234567890cbtk,123456789012345678901234567890ceth,100000000000000000000000000stake
sifnoded add-genesis-account $(sifnodecli keys show ${AKASHA_NAME} -a) 123456789012345678901234567890rowan,123456789012345678901234567890catk,123456789012345678901234567890cbtk,123456789012345678901234567890ceth,100000000000000000000000000stake
