...
sifnoded add-genesis-account $(sifnodecli keys show ${SHADOWFIEND_NAME} -a) 100000000000000000000000000000rowan,123456789012345678901234567890catk,100000000000000000000000000000cbtk,100000000000000000000000000000ceth,100000000000000000000000000000usdc,100000000000000000000000000000link,100000000000000000000000000stake
