export type TestSifAccount = { mnemonic: string; address: string };
export type TestEthAccount = { public: string; private: string };
export const akasha = {
  mnemonic:
...
export const ethAccounts = [
  ...
  {
    public: "0xC5fdf4076b8F3A5357c5E395ab970B5B54098Fef",
    private:
