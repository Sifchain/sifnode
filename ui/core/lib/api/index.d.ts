...
export declare type Api = ReturnType<typeof createApi>;
export declare type WithApi<T extends keyof Api = keyof Api> = {
    api: Pick<Api, T>;
};
export declare type ApiContext = EthereumServiceContext & SifServiceContext & ClpServiceContext & EthbridgeServiceContext & ClpServiceContext & EventBusServiceContext;
export declare function createApi(context: ApiContext): {
    ClpService: {
        getPools: () => Promise<{
    ...
    EthereumService: import("./IWalletService").IWalletService;
    SifService: {
        getState(): {
            connected: boolean;
            address: string;
