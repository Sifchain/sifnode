...
exports.SubscribeToUnconfirmedPegTxs = ({ services, store, config, }) => () => {
    if (!store.wallet.eth.address)
        return () => { };
    // Update a tx state in the store
    const subscribeToTx = subscribeToTx_1.SubscribeToTx({ store, services });
    function getSubscriptions() {
        return __awaiter(this, void 0, void 0, function* () {
            const pendingTxs = yield services.ethbridge.fetchUnconfirmedLockBurnTxs(store.wallet.eth.address, config.ethConfirmations);
