...
module.exports = async (cb) => {
    ...
    const err = () => {
        console.log("\nUsage: \nADDRESS='0x9201903991991...' truffle exec scripts/bulkSetTokenLockBurnLimit.js --network develop PATH_TO_WHITELIST_FILE.json\n\n\n");
    }
    ...
    try {
        ...
        bridgeBank = await BridgeBank.at(process.env.ADDRESS)
