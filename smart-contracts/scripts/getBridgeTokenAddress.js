module.exports = async () => {
  ...
  try {
    ...
    ******************************************/
    ...
    console.log("Attempting to call getBridgeToken() with symbol: '" + symbol + "'...");
    ...
    const bridgeTokenAddress = await contract.deployed().then(function(instance) {
      return instance.getBridgeToken.call(symbol, {
        from: accounts[0],
        value: 0,
        gas: 3000000 // 300,000 Gwei
      });
    });
    console.log(symbol + ' address: ' + bridgeTokenAddress)
