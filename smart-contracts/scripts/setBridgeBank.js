module.exports = async (cb) => {
  ...
  const expectedUsage = () => { console.log("Expected usage:\nBRIDGEBANK_ADDRESS='insert bridgebank address' COSMOS_BRIDGE_ADDRESS='insert cosmosbridge address' npx hardhat run --network localhost scripts/setBridgeBank.js\n") }
  try {
    /*******************************************
     *** Set up
    ******************************************/
    ...
    const CosmosBridgeContract = await hre.ethers.getContractFactory("CosmosBridge");
