...
export class SifnodedRunner extends ShellCommand<SifnodedResults> {
  ...
  async sifgenNetworkCreate(): Promise<SifnodedResults> {
    const sifgenArgs = [
      ...
      "--mint-amount",
      "999999000000000000000000000rowan,1370000000000000000ibc/feedfacefeedfacefeedfacefeedfacefeedfacefeedfacefeedfacefeedface,99999900000000000000000000sifBridge99990x0000000000000000000000000000000000000000",
    ]
  ...
  addAccount(name: string, homeDir: string, isAdmin: boolean): EbRelayerAccount {
    ...
    ChildProcess.execSync(
      `${this.sifnodedCommand} add-genesis-account ${accountAddress} 100000000000000000000rowan,1370000000000000000ibc/feedfacefeedfacefeedfacefeedfacefeedfacefeedfacefeedfacefeedface,99999900000000000000000000sifBridge99990x0000000000000000000000000000000000000000 --home ${homeDir}`,
      {encoding: "utf8"}
    ).trim()
    if (isAdmin === true) {
      ChildProcess.execSync(
