...
// TODO: Where is this used? This is for compiler to know the thing's type
...
export function subscribeToEthereumEvents(
  ...
  return new Observable<EthereumMainnetEvent>((subscriber) => {
    ...
    // TODO: Naming. Listener isnt really descriptive, this is etl logic triggered
    // by evm filter
    const logUnlockListener = (...args: any[]) => {
      console.log("Received unlock event")
...
// TODO: This is poor naming, revisit function overloading so we can merge with the above function
export function subscribeToEthereumCosmosEvents(
  cosmosBridge: CosmosBridge
): Observable<EthereumMainnetEvent> {
  return new Observable<EthereumMainnetEvent>((subscriber) => {
    // TODO: Could these be autogenerated?
