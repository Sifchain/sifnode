...
func main() {
	...
	_nodeCreateCmd.PersistentFlags().String("bond-amount", "10000000000000000000000000rowan", "bond amount")
	_nodeCreateCmd.PersistentFlags().String("mint-amount", "990000000000000000000000000rowan", "mint amount")
