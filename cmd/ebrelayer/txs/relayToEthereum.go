...
import (
	...
	oracle "github.com/Sifchain/sifnode/cmd/ebrelayer/contract/generated/bindings/oracle"
...
func RelayProphecyClaimToEthereum(provider string, contractAddress common.Address, event types.Event,
	...
	tx, err := cosmosBridgeInstance.NewProphecyClaim(auth, uint8(claim.ClaimType),
		claim.CosmosSender, claim.EthereumReceiver, claim.Symbol, claim.Amount.BigInt())
	if err != nil {
		log.Println(err)
		return err
	}
