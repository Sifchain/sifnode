...
yes Y | sifnodecli tx clp create-pool --from user1 --sourceChain ETHEREUM --symbol ETH --ticker ETH --nativeAmount 10000 --externalAmount 10000
sleep 8
yes Y | sifnodecli tx clp create-pool --from user1 --sourceChain TEZOS --symbol XTZ --ticker XTZ --nativeAmount 10000 --externalAmount 10000
...
echo "swap"
sleep 8
yes Y |  sifnodecli tx clp swap --from user1 --sentSourceChain ETHEREUM --sentSymbol ETH --sentTicker ETH --receivedSourceChain TEZOS --receivedSymbol XTZ --receivedTicker XTZ --sentAmount 1000
