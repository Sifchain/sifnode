...
yes Y | sifnodecli tx clp create-pool --from user1 --sourceChain ROWAN --symbol EOSROWAN --ticker EOS --nativeAmount 1000 --externalAmount 1000
...
sleep 8
yes Y | sifnodecli tx clp add-liquidity --from user1 --sourceChain ROWAN --symbol EOSROWAN --ticker EOS --nativeAmount 1000 --externalAmount 1000


echo "removing Liquidity"
sleep 8
yes Y | sifnodecli tx clp remove-liquidity --from user1 --sourceChain ROWAN --symbol EOSROWAN --ticker EOS --wBasis 10000 --asymmetry 1
